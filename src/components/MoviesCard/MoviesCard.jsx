...
function MoviesCard(props) {
  ...
  React.useEffect(() => {
    if (
      props.savedFilms.find((c) => c.movieId === props.card.id) !== undefined
    ) {
    ...
    <div className="movies-card" id={props.card.id}>
      <div className="movies-card__name-container">
        ...
        <p className="movies-card__duration">
          {convertMinutesToHoursAndMinutes(props.card.duration)}
        </p>
      </div>
      <img
        ...
        src={
          ...
          (props.isOnSavedMoviesPage === true && `${props.card.image}`)
        }
        alt={props.nameRU}
        onClick={handleClick}
      />
      ...
      {props.isOnSavedMoviesPage === true && (
        <button
