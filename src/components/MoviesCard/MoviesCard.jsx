...
function MoviesCard(props) {
    ...
    React.useEffect(() => {
        ...
        } else if (props.savedFilms.find(c => c.movieId === props.card.id) === undefined && (window.location.href === 'http://localhost:3001/movies' || window.location.href === 'https://movies-ana-bear.nomoredomains.xyz/movies')){
            let card = document.getElementById(props.card.id);
            console.log(card)
            let btnSave = card.querySelector(".movies-card__save");
            console.log(btnSave)
